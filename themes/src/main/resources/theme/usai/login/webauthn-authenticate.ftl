        ...
        <div id="kc-form-webauthn" class="${properties.kcFormClass!}">
            ...
            <div class="${properties.kcFormGroupClass!} no-bottom-margin">
                <div class="usa-card__body">
                    <p class="login-description">Use your security key to sign in to USAi.</p>
                    ...
                    <#if authenticators??>
                        ...
                        <#if shouldDisplayAuthenticators?? && shouldDisplayAuthenticators>
                            ...
                            <div class="${properties.kcFormClass!} webauthn-authenticators">
                                <#list authenticators.authenticators as authenticator>
                                    <div id="kc-webauthn-authenticator-item-${authenticator?index}" class="${properties.kcSelectAuthListItemClass!} usa-card webauthn-authenticator-item">
